...
# 使用示例
folder_path = r'D:\DELL\Documents\ExperimentDataToolkit\data\20250118\1480~1640-2cycle-sweep-back~forw-1.0Gain-5000Expsure\CP\1\pos_mid-1.000~15.835-~42~90\forw_back-added\back'  # 请替换为实际路径
# start = 1480  # 起始命名
# end = 1640  # 终止命名
start = 1640  # 起始命名
end = 1480  # 终止命名
